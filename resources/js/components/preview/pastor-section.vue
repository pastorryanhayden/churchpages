<template>
    <div>
        <div class="bg-white overflow-hidden" v-if="pastor">
            <div class="relative max-w-screen-xl mx-auto pt-20 pb-12 px-4 sm:px-6 lg:px-8 lg:py-20">
                ...
                <div class="relative lg:flex lg:items-center">
                    <div class="hidden lg:block lg:flex-shrink-0">
                        <img class="h-64 w-64 rounded-full xl:h-80 xl:w-80 object-cover" src="/Ledbetter.jpg"
                            alt="" />
                    </div>
                    ...
                    <div class="relative lg:ml-10">
                        ...
                        <blockquote>
                            <div class="text-2xl leading-9 font-medium text-gray-900">
                                <p>
                                    We would love for you to be our guest this Sunday at Victory Baptist
                                    Church. You'll find our church family to be warm and welcoming. Our
                                    emphasis is on lifting up Christ, preaching the gospel, and being faithful
                                    to Him and His word - if that appeals to you - we think you'll enjoy
                                    Victory Baptist.
                                </p>
                            </div>
                            <footer class="mt-8">
                                <div class="flex">
                                    <div class="flex-shrink-0 lg:hidden">
                                        <img class="h-12 w-12 rounded-full object-cover" src="/Ledbetter.jpg"
                                            alt="" />
                                    </div>
                                    <div class="ml-4 lg:ml-0">
                                        <div class="text-base leading-6 font-medium text-gray-900">Pastor Gary
                                            Ledbetter and his wife, Linda</div>
                                    </div>
                                </div>
                            </footer>
                        </blockquote>
        ...
        <div class="bg-white overflow-hidden" v-else>
            <div class="relative max-w-screen-xl mx-auto pt-20 pb-12 px-4 sm:px-6 lg:px-8 lg:py-20">
                <svg class="absolute top-full left-0 transform translate-x-80 -translate-y-24 lg:hidden"
                    width="784" height="404" fill="none" viewBox="0 0 784 404">
                    <defs>
